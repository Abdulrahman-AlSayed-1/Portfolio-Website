    ...
    return ( 
       <nav className='navbar navbar-expand-md navbar-dark pt-lg-2 pt-4 fixed-top'>
         <div className="container-fluid">
            <Link className="navbar-brand col-md-2 col-3 text-md-center p-0 fs-1" to='/Project5-React#Home'>
            ...
            <div className="collapse navbar-collapse col-8 justify-content-center gap-4" id="mynavbar">
             <ul className={`navbar-nav fs-${responsive(6,5)}`}>
                ...
                <li className="nav-item  ">
                 <Link className='nav-link position-relative scroll-link' to='/Project5-React#Home' >Home</Link> 
                </li>

                <li className="nav-item ">
                 <Link className='nav-link position-relative scroll-link' to='/Project5-React#Skills'>Skills</Link>
                </li>

                <li className="nav-item ">
                 <Link className=' nav-link position-relative scroll-link' to='/Project5-React#Projects'>Projects</Link>
                </li>
             ...
             <button className={`bg-transparent text-light border-light mt-md-0 mt-3 fs-${responsive(6,5)} px-lg-5 px-4 py-3 rounded-0 contact-btn position-relative`}>
              <Link className='nav-link' to='/Project5-React/GetInTouch'>Let's Connect</Link>
             </button>
